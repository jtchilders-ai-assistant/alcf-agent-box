<!--
Snapshot metadata (do not remove):
  Title: Compiling and Linking Overview on Polaris
  Canonical URL: https://docs.alcf.anl.gov/polaris/compiling-and-linking/
  Retrieved: 2026-09-16
  Classification: official
  Upstream source: raw Markdown from github.com/argonne-lcf/user-guides (main)
-->
